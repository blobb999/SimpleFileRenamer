...
3.    Provide the episode and title patterns for renaming, or check the "Use names.txt" checkbox to use a names.txt file in the directory.
4.    Click "Start Renaming" to begin the renaming process.
5.    If necessary, click "Undo" to revert the renaming based on the rename_log.txt file.
6.    Click "Create Playlist" to generate a playlist (XSPF) file for the renamed video files.
